    ...
    <section className="section-shell flex items-center justify-center py-24 text-center md:min-h-[100svh]">
      <div className="mx-auto flex max-w-5xl flex-col items-center">
        ...
        <p className="mt-8 max-w-2xl text-lg text-secondary md:text-xl">
          Every consequential AI action needs a receipt. Permission Protocol issues it.
        </p>
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <Link href="/r/demo" className="btn-primary">
            See the receipt <ArrowRight className="ml-2 h-4 w-4" />
          </Link>
