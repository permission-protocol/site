    ...
    <section className="section-shell flex min-h-screen items-center justify-center py-28">
      <div className="w-full max-w-xl rounded-3xl border border-border bg-card p-8">
        ...
        <div className="mt-6 flex gap-3 text-sm">
          <button className="rounded-lg border border-border px-3 py-2">Copy link</button>
          <button className="rounded-lg border border-border px-3 py-2">Copy JSON</button>
          <button className="rounded-lg border border-border px-3 py-2">Download</button>
        </div>
